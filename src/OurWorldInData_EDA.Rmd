...
owid_tbl <- spark_read_csv(sc, name = "OWID", path = owid_path, memory = FALSE)
owid_summ <- owid_tbl |> group_by(location) |> summarize(count = n(),  mean = mean(total_deaths_per_million, na.rm = TRUE))
dplyr::show_query(owid_summ)
```
